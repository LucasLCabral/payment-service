//go:generate mockgen -destination=../settlement/mocks/payment_repository_mock.go -package=mocks github.com/LucasLCabral/payment-service/internal/payment/repository Payment
...
type Payment interface {
	...
	FindByIDTx(ctx context.Context, tx *sql.Tx, id uuid.UUID) (*payment.Payment, error)
